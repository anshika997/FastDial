...
export default function Dashboard() {
  ...
  return (
          ...
          /*
    {
      ...
      icon: faUsersCog,
      page: "AffidavitsRequest",
    },
    {
      label: "Business Registration",
      icon: faUsersCog,
      page: "BusinessRegistrationForm",
    },
    {
    ...
    },
    {
      ...
      icon: faUsersCog,
      page: "PartnerRegistrationPage",
    },
    {
      label: "Property Registration",
      icon: faUsersCog,
      page: "PropertyRegistration",
    },
    {
    ...
    */
          {
            label: "GST List",
            icon: faList,
            page: "InsertGstRegistrations",
          },
          {
            label: "Insert Pan Registrations",
            icon: faRegistered,
            page: "insertPanRegistrations",
          },
          {
            label: "Insert Tan Registrations",
            icon: faChartBar,
            page: "insertTanRegistrations",
          },
          {
            label: "Insert Tds Returns",
            icon: faTruck,
            page: "InsertTdsReturns",
          },
          {
            label: "Insert Legal Notices",
            icon: faTruck,
            page: "insertLegalNotices",
          },
          {
            label: "Insert Sale Aggrement",
            icon: faCalendarTimes,
            page: "InsertSaleAggrement",
          },
          {
            label: "Insert Saledeed Registration",
            icon: faCalendarTimes,
            page: "InsertSaledeed",
          },
          {
            label: "Insert Affidavid",
            icon: faSackXmark,
            page: "insertAffidavid",
          },
        ].map((item, index) => (
          <div
            key={index}
