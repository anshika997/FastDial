...
export default function ListOfPropertyRegistration() {
  ...
  const [showTimeline, setShowTimeline] = useState(false); // State to manage the visibility of the Timeline
  ...
  const openTimeline = (item) => {
    ...
    setShowTimeline(true); // Show the Timeline component
  };

  const closeTimeline = () => {
    setShowTimeline(false); // Hide the Timeline component
            ...
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="bg-gray-200 text-gray-700 text-sm">
                  ...
                  <th className="p-3 text-center">First Person</th>
                  <th className="p-3 text-center">Second Person</th>
                  <th className="p-3 text-center">Rejected By</th>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="p-3">
                        {item.first_person_details || "NA"}
                      </td>
                      <td className="p-3">
                        {item.second_person_details || "NA"}
                      </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-2/4 max-w-xxl shadow-lg relative  h-80 md:h-80 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  <strong>First Person Name:</strong>{" "}
