          ...
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-2/4 max-w-xxl shadow-lg relative  h-80 md:h-80 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {[
                ...
                { label: "Aadhar Card", field: "aadhar_url" },
                { label: "Residental Proof", field: "residental_proof_url" },
                { label: "Bank Statement", field: "bank_statement_url" },
                { label: "Director Aadhar", field: "vendor_id" },
              ].map(({ label, field }) => (
                <div key={field}>
                  <p>
                    <strong>{label}:</strong>
