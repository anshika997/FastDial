...
export default function ListOfPropertyRegistration() {
  ...
  function fetchData() {
    axios
      .get(`${BASEURL}/data/getTdsReturns`, {
        headers: {
            ...
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="bg-gray-200 text-gray-700 text-sm">
                  ...
                  <th className="p-3 text-center">Assigned Vendor</th>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-2/4 max-w-xxl shadow-lg relative  h-80 md:h-80 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* <div>
                <p>
                  <strong>Photo:</strong> {selectedData.photo_url || "N/A"}
                </p>
              </div>

              <div>
                <p>
                  <strong>Aadhar Card:</strong> {selectedData.aadhar_url || "N/A"}
                </p>
              </div>

              <div>
                <p>
                  <strong>Residental Proof:</strong> {selectedData.residental_proof_url || "N/A"}
                </p>
              </div> */}
              ...
              {/* <div>
                <p>
                  <strong>Bank Statement:</strong> {selectedData.bank_statement_url || "N/A"}
                </p>
              </div> */}
              ...
              <div>
                <p>
                  <strong>Vendor:</strong> {selectedData.vendor_id || "N/A"}
                </p>
              </div>

              {/* Images */}
              {[
                { label: "tds_statement_url", field: "tds_statement_url" },
                { label: "any_statement_id", field: "any_statement_id" },
              ].map(({ label, field }) => (
                <div key={field}>
                  <p>
                    <strong>{label}:</strong>
