            ...
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="bg-gray-200 text-gray-700 text-sm">
                  ...
                  <th className="p-3 text-center">Sale Amount</th>
                  <th className="p-3 text-center">Advance Received</th>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="p-3">{item.sale_amount || "NA"}</td>
                      <td className="p-3">{item.advance_received || "NA"}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-2/4 max-w-xxl shadow-lg relative  h-80 md:h-80 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    <p>
                      ...
                      {selectedData.purchaser_details || "N/A"}
                    </p>
                  </div>
                  <div>
                    <p>
                      <strong>Seller Details:</strong>{" "}
                      {selectedData.seller_details || "N/A"}
                    </p>
                  </div>
                  <div>
                    <p>
                      <strong>Sale Amount:</strong>{" "}
                      {selectedData.sale_amount || "N/A"}
                    </p>
                  </div>
                  <div>
                    <p>
                      <strong>Advance Received:</strong>{" "}
                      {selectedData.advance_received || "N/A"}
                    </p>
                  </div>
              ...
              {/* Images */}
              {[{ label: "Tax Receipt", field: "tax_receipt_URL" }].map(
                ({ label, field }) => (
                  <div key={field}>
                    <p>
                      <strong>{label}:</strong>
