  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-6 mt-8 lg:px-40">
        {[
          {
            label: "Services Opted Dashboard",
            icon: faTh,
            bg: "bg-green-900",
            color: "text-white",
            page: "UserForUpdate",
          ...
          // },
          // {
          //   label: "Gst Registration Company",
          //   icon: faUsersCog,
          //   page: "GstRegistrationCompany",
          // },
         /* 
{
  label: " Property Registration",
  icon: faUsersCog,
  page: "UserListOfPropertyRegistration",
},
{
  label: " Gst Registration",
  icon: faUsersCog,
  page: "UserListOfGstRegistration",
},
{
  label: " Affidavits Request",
  icon: faUsersCog,
  page: "UserListAffidavitsRequest",
},
*/

          // {
          //   label: "Affitdavits Requests",
          //   icon: faUsersCog,
          //   page: "affitdavit",
          // },
          {
            label: " GST LIST Request",
            icon: faUsersCog,
            page: "GSTListRequest",
          },
          {
            label: "Pan Registrations Request",
            icon: faSackXmark,
            page: "PanRegistrationsRequest",
          },
          {
            label: "Tan Registrations Request",
            icon: faCalendarAlt,
            page: "TanRegistrationsRequest",
          },
          {
            label: "Tds Returns Request",
            icon: faTruck,
            page: "TdsReturnsRequest",
          },
          {
            label: "Legal Notices Request",
            icon: faChartPie,
            page: "LegalNoticesRequest",
          },
          {
            label: "Sale Aggrement Request",
            icon: faBars,
            page: "SaleAggrementRequest",
          },
          {
            label: "Sale Deed Request",
            icon: faChartLine,
            page: "SaledeedRequest",
          },
          {
            label: "Affidavid Request",
            icon: faImage,
            page: "AffidavidRequest",
          }
        ].map((item, index) => (
          <div
            key={index}
