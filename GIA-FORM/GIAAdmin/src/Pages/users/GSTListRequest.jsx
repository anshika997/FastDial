                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-3">{item.pan_no || "NA"}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-2/4 max-w-xxl shadow-lg relative  h-80 md:h-80 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* <div>
                <p>
                  <strong>Electricity Bill:</strong> {selectedData.electricity_bill_url || "N/A"}
                </p>
              </div>

              <div>
                <p>
                  <strong>Rental Agreement:</strong> {selectedData.rental_agreement_url || "N/A"}
                </p>
              </div>

              <div>
                <p>
                  <strong>Director Photo:</strong> {selectedData.director_photo_url || "N/A"}
                </p>
              </div> */}
              ...
              {/* <div>
                <p>
                  <strong>Director Pan:</strong> {selectedData.director_pan_url || "N/A"}
                </p>
              </div> */}
              ...
              {/* <div>
                <p>
                  <strong>Director Aadhar:</strong>{" "}
                  {selectedData.director_aadhar_url || "N/A"}
                </p>
              </div> */}
