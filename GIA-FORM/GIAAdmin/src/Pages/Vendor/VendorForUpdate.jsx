  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        <section className="flex  justify-between items-center">
          <div>
            ...
            <h1 className="font-extrabold text-2xl capitalize">
              {loogedInUser ? loogedInUser : "Vendor"}
            </h1>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-6 mt-8 lg:px-40">
        {[
          {
            label: "Vendor List Of Enquiries",
            icon: faTh,
            bg: "bg-green-900",
            color: "text-white",
            page: "VendorForUpdate",
          },
          // {
          ...
          // },
          {
            ...
            icon: faUsersCog,
            page: "VendorListOfPropertyRegistration",
          },
          {
            label: "Gst Registration",
            icon: faUsersCog,
            page: "VendorListOfGstRegistration",
          },
          {
            label: " Affidavits Request",
            icon: faUsersCog,
            page: "VendorListAffidavitsRequest",
          },
          // {
