...
export default function ListOfPropertyRegistration() {
  ...
  function fetchData() {
    axios
      .get(`${BASEURL}/data/getGstRegistrationCompany?assigned_vendor=7`, {
        headers: {
    ...
    axios
      .get(
        `${BASEURL}/data/getVendors?vendor_bussiness_name=GST Registration`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const handleApprove = (id) => {
    ...
    axios
      .post(
        `${BASEURL}/data/updateGstRegistrationCompany`,
        {
          id: id,
          is_approved: 1,
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="px-10 flex items-center justify-between">
        <h1 className="text-center my-4 text-xl font-bold">
          List Of Gst Registration Company
        </h1>
      </div>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b">
                      <td>{item.id}</td>
                      <td>{item.director_name ? item.director_name : "NA"}</td>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  ...
                  {selectedData.director_name || "N/A"}
                </p>
              </div>
              ...
              <div>
                <p>
                  ...
                  {selectedData.bank_acc_name || "N/A"}
                </p>
              </div>
              ...
              <div>
                <p>
                  ...
                  {selectedData.bank_acc_number || "N/A"}
                </p>
              </div>
              ...
              <div>
                <p>
                  ...
                  {selectedData.bank_ifsc_code || "N/A"}
                </p>
              </div>
              ...
              {[
                {
                  ...
                  field: "bussiness_address_proof_url",
                },
                { label: "Company PAN", field: "company_pan_url" },
                { label: "Director Aadhar", field: "director_aadhar_url" },
                {
                  label: "GST Authorization Letter",
                  field: "gst_auth_director_letter_url",
                },
              ].map(({ label, field }) => (
                <div key={field}>
                  <p>
