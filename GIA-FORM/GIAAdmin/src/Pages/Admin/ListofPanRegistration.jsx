...
function ListofPanRegistration() {
  ...
  function fetchData() {
    axios
      .get(`${BASEURL}/data/getPanRegistrations`, {
        headers: {
  ...
  const handleApprove = (id) => {
    ...
    axios
      .post(
        `${BASEURL}/data/updatePanRegistrations`,
        {
          id: id,
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updatePanRegistrations`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const HandleDelete = (id) => {
    ...
    axios
      .delete(`${BASEURL}/data/deletePanRegistrations/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center w-full">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-3/4 shadow-lg relative h-80 md:h-88 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  <strong>Aadhar URL:</strong>{" "}
                  {selectedData.aadhar_url ? (
                    <a
                      href={selectedData.aadhar_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
              ...
              <div>
                <p>
                  <strong>Residential Proof URL:</strong>{" "}
                  {selectedData.residental_proof_url ? (
                    <a
                      href={selectedData.residental_proof_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
                      View Residential Proof
                    </a>
                  ) : (
                    "N/A"
                  )}
              ...
              <div>
                <p>
                  <strong>Bank Statement URL:</strong>{" "}
                  {selectedData.bank_statement_url ? (
                    <a
                      href={selectedData.bank_statement_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
