...
function ListofTdsReturns() {
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updateTdsReturns`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const HandleDelete = (id) => {
    ...
    axios
      .delete(`${BASEURL}/data/deleteTdsReturns/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-2">{item.any_statement_id}</td>
                      <td className="p-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  ...
                  {selectedData.any_statement_id || "N/A"}
                </p>
              </div>
              <div>
                <p>
...
export default ListofTdsReturns;
