...
function ListofPanRegistration() {
  ...
  function fetchData() {
    ...
    axios
      .get(`${BASEURL}/data/getVendors?vendor_bussiness_name=SaleAggrement`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const handleApprove = (id) => {
    ...
    axios
      .post(
        `${BASEURL}/data/updateSaleAggrement`,
        {
          id: id,
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updateSaleAggrement`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
            ...
            <table className="min-w-max w-full border-collapse">
              <thead>
                <tr className="bg-gray-200 text-sm text-center">
                  ...
                  <th className="p-2">Advance Received</th>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-2">{item.sale_amount}</td>
                      <td className="p-2">{item.advance_received}</td>
                      <td className="p-2">
