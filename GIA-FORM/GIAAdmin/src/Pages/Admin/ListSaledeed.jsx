...
function ListofPanRegistration() {
  ...
  function fetchData() {
    ...
    axios
      .get(`${BASEURL}/data/getVendors?vendor_bussiness_name=Saledeed`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updateSaledeed`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="px-10 flex items-center justify-between">
        <h1 className="text-center my-4 text-xl font-bold">List Of SaleDeed</h1>
      </div>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-3">
                        {item.advance_received?.toLocaleString()}
                      </td>
                      <td className="p-3">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center w-full">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-3/4 shadow-lg relative h-80 md:h-88 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  <strong>Tax Receipt URL:</strong>{" "}
                  {selectedData.tax_receipt_URL ? (
                    <a
                      href={selectedData.tax_receipt_URL}
                      target="_blank"
