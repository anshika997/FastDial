...
function ListofPanRegistration() {
  ...
  function fetchData() {
    axios
      .get(`${BASEURL}/data/getTanRegistrations`, {
        headers: {
    ...
    axios
      .get(
        `${BASEURL}/data/getVendors?vendor_bussiness_name=TanRegistrations`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  const handleApprove = (id) => {
    ...
    axios
      .post(
        `${BASEURL}/data/updateTanRegistrations`,
        {
          id: id,
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updateTanRegistrations`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-2">{item.vendor_id}</td>
                      <td className="p-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  ...
                  {selectedData.pan_url ? (
                    <a
                      href={selectedData.pan_url}
                      target="_blank"
              ...
              <div>
                <p>
                  <strong>Authorised Signatory URL:</strong>{" "}
                  {selectedData.authorised_signatory_url ? (
                    <a
                      href={selectedData.authorised_signatory_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
              ...
              <div>
                <p>
                  <strong>DSC URL:</strong>{" "}
                  {selectedData.dsc_url ? (
                    <a
                      href={selectedData.dsc_url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
              ...
              <div>
                <p>
                  ...
                  {selectedData.vendor_id ? (
                    <a
                      href={selectedData.vendor_id}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-500 underline"
                    >
