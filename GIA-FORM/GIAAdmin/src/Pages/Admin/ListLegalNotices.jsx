...
function ListLegalNotices() {
  ...
  function fetchData() {
    axios
      .get(`${BASEURL}/data/getLegalNotices`, {
        headers: {
  ...
  const handleApprove = (id) => {
    ...
    axios
      .post(
        `${BASEURL}/data/updateLegalNotices`,
        {
          id: id,
  ...
  const handleSubmitRejection = (id) => {
    ...
    axios
      .post(`${BASEURL}/data/updateLegalNotices`, payload, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
  ...
  const HandleDelete = (id) => {
    ...
    axios
      .delete(`${BASEURL}/data/deleteLegalNotices/${id}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
            ...
            <table className="min-w-max w-full border-collapse">
              <thead>
                <tr className="bg-gray-200 text-sm text-center">
                  ...
                  <th className="p-2">First Person Details</th>
                  <th className="p-2">Second Person Details</th>
                ...
                {filteredData.length > 0 ? (
                  filteredData.map((item, index) => (
                    <tr key={index} className="border-b text-sm text-center">
                      ...
                      <td className="p-2">{item.first_person_details}</td>
                      <td className="p-2">{item.second_person_details}</td>
                      <td className="p-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center w-full">
          <div className="bg-white rounded-lg p-6 w-[95%] lg:w-3/4 shadow-lg relative h-80 md:h-88 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <p>
                  <strong>First Person Details:</strong>{" "}
                  {selectedData.first_person_details || "N/A"}
                </p>
              </div>
              <div>
                <p>
                  <strong>Second Person Details:</strong>{" "}
                  {selectedData.second_person_details || "N/A"}
                </p>
              </div>
              {/* <div>
                <p>
                  <strong>Statement url:</strong>{" "}
                  {selectedData.tds_statement_url ? (
                    <a
                      href={selectedData.tds_statement_url}
                      target="_blank"
...
export default ListLegalNotices;
