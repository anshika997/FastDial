...
export const loginCustomerAPI = (customer_email, password) => {
  console.log('loginCustomerAPI: Request:', { customer_email });
  return api.post('/customers/login', { customer_email, password }).then((response) => {
...
export const signupCustomerAPI = (customer_name, customer_email, mobile, password) => {
  console.log('signupCustomerAPI: Request:', { customer_name, customer_email, mobile });
  return api.post('/customers/signup', { customer_name, customer_email, mobile, password });
};

export const verifyOtpAPI = (customer_email, otp) => {
  console.log('verifyOtpAPI: Request:', { customer_email, otp });
  return api.post('/customers/verify-otp', { customer_email, otp });
};

export const resendOtpAPI = (customer_email) => {
  console.log('resendOtpAPI: Request:', { customer_email });
  return api.post('/customers/resend-otp', { customer_email });
};
