        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-900 text-base">
              {profile.bussiness_address
                ? typeof profile.bussiness_address === 'object'
                  ? [profile.bussiness_address.street, profile.bussiness_address.city, profile.bussiness_address.state].filter(Boolean).join(', ')
                  : profile.bussiness_address
                : "N/A"}
            </p>
          </div>
