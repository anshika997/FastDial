...
const Login = () => {
  ...
  useEffect(() => {
    if (requiresVerification && pendingVerificationEmail) {
      console.log('Redirecting unverified vendor to signup OTP step:', pendingVerificationEmail);
      navigate('/vendorsignup', { state: { fromLoginUnverified: true, email: pendingVerificationEmail } });
    }
  }, [requiresVerification, pendingVerificationEmail, navigate]);
