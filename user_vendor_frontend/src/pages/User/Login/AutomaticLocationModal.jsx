                                ...
                                if (i < 3) {
                                    return (
                                        <div
                                            ...
                                            className="text-slate-800 border border-black flex w-full items-center rounded-md p-3 transition-all hover:bg-slate-200 focus:bg-slate-200 active:bg-blue-100"
                                        >
                                            {item.join(", ")}
                                        </div>
                                    )
